        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <input type="text" class="form-control" id="nik" name="nik" value="<?= $administrator['nik'] ?>">
                </div>
                <div class="col-4">
                    <label for="nama">Nama</label>
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= $administrator['nama'] ?>">
                </div>
                <div class="col-4">
