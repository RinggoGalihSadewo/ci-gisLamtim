...
$routes->get('admin/map-settings/edit/(:num)/galeri-foto', 'MapSettingsController::galeri/$1');
$routes->get('admin/map-settings/edit/(:num)/galeri-foto/upload', 'MapSettingsController::uploadGaleri/$1');
$routes->post('admin/map-settings/edit/(:num)/galeri-foto/upload', 'MapSettingsController::saveGaleri/$1');
$routes->get('admin/map-settings/edit/(:num)/galeri-foto/delete', 'MapSettingsController::deleteGaleri/$1');
